...
//
// What a seller publishes, and what a buyer compares. Five groups: who is
// selling, what the flight is and when, what it can carry a satellite in,
// what it costs and by when you must answer, and what is in the price versus
// what is extra.
export const LISTINGS = [
  {
    ...
    sellerType: 'Launcher', nation: 'DE', flight: 'Spectrum F3', offer: 'Firm', confirmed: true,
    ...
    included: ['Separation system', 'Integration support', 'Licensing'], addOns: ['Testing +£40k', 'Bus +on request'],
  },
  {
    ...
    sellerType: 'Launcher', nation: 'FR', flight: 'Vega C VV29', offer: 'Firm', confirmed: true,
    ...
    included: ['Separation system', 'Delivery', 'Licensing'], addOns: ['Testing +€55k', 'OTV +on request'],
  },
  {
    ...
    sellerType: 'Launcher', nation: 'US', flight: 'Bandwagon-5', offer: 'Firm', confirmed: true,
  ...
  },
  {
    ...
    sellerType: 'Broker', nation: 'IN', flight: 'PSLV-C64', offer: 'Waitlist', confirmed: false,
  ...
  },
  {
    ...
    sellerType: 'Launcher', nation: 'DE', flight: 'RFA ONE F4', offer: 'Firm', confirmed: false,
    ...
    included: ['Separation system', 'Integration support'], addOns: ['Testing +£35k'],
  },
  {
    ...
    sellerType: 'Launcher', nation: 'FR', flight: 'Ariane 6 VA265', offer: 'Firm', confirmed: true,
  ...
  },
  {
    ...
    sellerType: 'Launcher', nation: 'DE', flight: 'Spectrum F5', offer: 'Firm', confirmed: false,
    ...
    included: ['Separation system', 'Integration support', 'Licensing'], addOns: ['Testing +£40k'],
  },
  {
    ...
    lMinus: 'L−8 weeks', delivery: '14 Nov 2026', spareMass: 320, price: '£33k / kg',
    watchers: 2, matches: 2,
    sellerType: 'Launcher', nation: 'DE', flight: 'RFA ONE F6', offer: 'Firm', confirmed: true,
    ...
    included: ['Separation system', 'Integration support'], addOns: ['Testing +£35k', 'Delivery +£8k'],
  },
  {
    ...
    watchers: 0, matches: 0,
    sellerType: 'Launcher', nation: 'US', flight: 'Bandwagon-6', offer: 'Waitlist', confirmed: false,
  ...
  },
  {
    ...
    watchers: 1, matches: 0,
    sellerType: 'Broker', nation: 'IN', flight: 'SSLV-D5', offer: 'Waitlist', confirmed: false,
...
export const ACTIVITY = {
  buy: [
    ...
    { event: 'WindowChanged', line: 'RFA ONE F6 moved to Q1 2027 — delivery date now 14 Nov 2026', at: '1d' },
